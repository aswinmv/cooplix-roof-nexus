...
const Hero = () => {
  return <div className="relative bg-cooplix-800 text-white overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 py-24 sm:py-32 md:py-40 z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-cooplix-100 mb-8 animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>Expert in roof estimation, drafting, material ordering, scheduling, documentation, and AppliCad-based estimations for builders and contractors.</p>
