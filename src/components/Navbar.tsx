      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link
              to="/"
              className="text-gray-700 hover:text-cooplix-600 transition-colors px-3 py-2 text-sm font-medium"
            >
              Home
            </Link>
            <Link
          ...
          <div className="hidden md:flex">
            <Button 
              asChild
              className="bg-cooplix-500 hover:bg-cooplix-600 text-white"
            >
              <Link to="/contact">
                Get an Estimate
              </Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
              to="/"
              className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-cooplix-500 hover:bg-gray-50"
              onClick={toggleMenu}
            >
              Home
            </Link>
